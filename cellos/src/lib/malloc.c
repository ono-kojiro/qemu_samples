...
/*
  ...
  Special defines for cellos libc
  ...
  essentially the effect of the cellos weak alias approach). It would
...
History:
	...
	foreign sbrks
      * Add cellos mremap support code from HJ Liu
	...
	courtesy of Wolfram Gloger (Gloger@lrz.uni-muenchen.de).
      * Added macros etc., allowing use in cellos libc from
